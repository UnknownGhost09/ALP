...
class membership(models.Model):
    ...
    principal_amount_per_month=models.CharField(max_length=250,default='10')
    principal_amount=models.CharField(max_length=250,default='100')
...
class UserMembership(models.Model):
    ...
    principal_amount=models.CharField(max_length=250,default='0')
...
class Principallogs(models.Model):
    plan_id=models.ForeignKey("core.UserMembership", db_column='plan_id', on_delete=models.CASCADE)
    date=models.CharField(max_length=200,default=datetime.utcnow())
    status=models.CharField(max_length=100,default='1')
